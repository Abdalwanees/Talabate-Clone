...
namespace Talapate.Clone.Services.Services
{
    public class OrderService : IOrderService
    {
        ...
        public OrderService(IBasketRepository basketRepo,/*IGenaricRepository<Product> productRepo,IGenaricRepository<DelivaryMethod> delivaryRepo,IGenaricRepository<Order> orderRepo*/IUnitOfWork repo)
        {
            _repo = repo;
